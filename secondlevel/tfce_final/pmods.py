...
def pmod_func(index,session,p_value,run):
    ...
    for folder in ['FirstLevel_pmod_normal','FirstLevel_pmod_gripdur']:

        if folder == 'FirstLevel_pmod_normal':
            output_folder1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_normal_noslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_normal_noslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        elif folder == 'FirstLevel_pmod_gripdur':
            output_folder1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_grip_duration_noslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_grip_duration_noslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        ...
        mask_ = datasets.load_mni152_gm_mask()
        mask = resample_to_img(mask_,second_level_input[0],interpolation='nearest')
        brain_masker = NiftiMasker(mask_img=mask)
        


        brain_data = brain_masker.fit_transform(second_level_input)
        
        beh_vars = np.array(design_matrix['intercept']).reshape(-1, 1)
        
        from nilearn.mass_univariate import permuted_ols
        
        out_dict = permuted_ols(
            tested_vars=beh_vars,
            target_vars=brain_data,
        ...
        plot2.savefig(os.path.join(output_folder_non1,'{}_tfce.png'.format(contrast)),dpi=300)
        ...
        if folder == 'FirstLevel_pmod_normal':
            output_folder2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_normal_withslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_normal_withslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        elif folder == 'FirstLevel_pmod_gripdur':
            output_folder2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_grip_duration_withslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/tfce/pmod_grip_duration_withslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        ...
        plot2.savefig(os.path.join(output_folder_non2,'{}_tfce.png'.format(contrast)),dpi=300)