...
folder = '/mnt/scratch/projects/PBCTI/BIDS_FINAL/BIDS_dataset_20230531-1633/derivatives/task_output/FirstLevel/FirstLevel_pmod_normal/'
pdf_pages = pdf.PdfPages('pbcti_qc_pmod_normal.pdf')
contrast_paths = []
