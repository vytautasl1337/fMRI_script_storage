...
def no_pmods(index,session,p_value,run):
    ...
    contrasts = ['go','rightgo','leftgo',
                ...
                'highlow','lowhigh','righthighlow',
                'lefthighlow','rightlowhigh','leftlowhigh',
                'leftrighthigh','rightlefthigh',
                'leftrightlow','rightleftlow']
                
    contrast=contrasts[index-1]
    
    for folder in ['FirstLevel_finalfinal']:#,'FirstLevel_pmod_gripdur']:

        if folder == 'FirstLevel_finalfinal':
            output_folder1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/Final/main/{}/{}/{}'.format(p_value,run,contrast))
        ...
        if folder == 'FirstLevel_finalfinal':
            output_folder2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/Final/main_slope/{}/{}/{}'.format(p_value,run,contrast))
        ...
        for b in range(beh_ref.shape[0]):
            ...
            if contrast in ['rightgo']:
                slope = sub_data[(sub_data['GripResponse'] == 1)]['Slope'].mean()
                
            if contrast in ['leftgo']:
                slope = sub_data[(sub_data['GripResponse'] == -1)]['Slope'].mean()
                
            if contrast in ['leftright']:
            ...
            if contrast in ['rightleft']:
                slope_left = sub_data[(sub_data['GripResponse'] == -1)]['Slope'].mean()
                slope_right = sub_data[(sub_data['GripResponse'] == 1)]['Slope'].mean()
                slope = slope_right - slope_left
                
            if contrast in ['gohigh']:
                slope = sub_data[(sub_data['RewardPromise'] == 1)]['Slope'].mean()
                
            if contrast in ['golow']:
                slope = sub_data[(sub_data['RewardPromise'] == -1)]['Slope'].mean()
                
            if contrast in ['gohighright']:
                slope = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                
            if contrast in ['gohighleft']:
                slope = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                
            if contrast in ['golowright']:
                slope = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                
            if contrast in ['golowleft']:
                slope = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                
            if contrast in ['highlow']:
            ...
            if contrast in ['lowhigh']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)]['Slope'].mean()
                slope = slope_low - slope_high
                
            if contrast in ['righthighlow']:
            ...
            if contrast in ['lefthighlow']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope = slope_high - slope_low
                
            if contrast in ['rightlowhigh']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope = slope_low -slope_high 
                
            if contrast in ['leftlowhigh']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope = slope_low - slope_high
                
            if contrast in ['leftrighthigh']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope =  slope_high - slope_low
                
            if contrast in ['rightlefthigh']:
                slope_high = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == 1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope =  slope_high - slope_low
                
            if contrast in ['leftrightlow']:
                slope_high = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope =  slope_high - slope_low
                
            if contrast in ['rightleftlow']:
                slope_high = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==1)]['Slope'].mean()
                slope_low = sub_data[(sub_data['RewardPromise'] == -1)&(sub_data['GripResponse']==-1)]['Slope'].mean()
                slope =  slope_high - slope_low
