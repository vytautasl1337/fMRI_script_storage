    ...
    for folder in ['FirstLevel_pmod_normal_RT']:#,'FirstLevel_pmod_gripdur']:
        ...
        if folder == 'FirstLevel_pmod_normal_RT':
            output_folder1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/RTnormal_noslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non1 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/RTnormal_noslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        ...
        if folder == 'FirstLevel_pmod_normal_RT':
            output_folder2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/RTnormal_withslope/{}/{}/{}'.format(p_value,run,contrast))
            output_folder_non2 = os.path.join(working_dir,
                'derivatives/task_output/SecondLevel/RTnormal_withslope_nonparam/{}/{}/{}'.format(p_value,run,contrast))
        elif folder == 'FirstLevel_gripdur':
            output_folder2 = os.path.join(working_dir,
