...
corrections_list = ['{}<{}-'.format(correction,signif)]*17*2
...
#####################################################################################################
save_folder = '/mnt/scratch/projects/PBCTI/BIDS_FINAL/BIDS_dataset_20230531-1633/derivatives/task_output/SecondLevel/SecondLevel_paper/{}/{}'.format(signif,label)
