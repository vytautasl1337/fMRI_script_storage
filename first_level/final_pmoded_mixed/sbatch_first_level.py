...
derivatives_folder = os.path.join(os.path.join(working_dir,'derivatives/task_output/FirstLevel_pmoded_mixed'))
...
beh_path = '/mnt/projects/PBCTI/combined/Results/Group_output_202402081541/'
