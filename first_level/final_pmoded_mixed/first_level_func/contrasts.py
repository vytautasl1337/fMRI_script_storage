...
def my_contrasts(design_matrix):
    ...
    gohigh = basic_contrasts['HighReward'] + basic_contrasts['LeftGo_pmod'] + basic_contrasts['RightGo_pmod']
    golow = basic_contrasts['LowReward'] + basic_contrasts['LeftGo_pmod'] + basic_contrasts['RightGo_pmod']
    gohighleft = basic_contrasts['HighReward'] + basic_contrasts['LeftGo_pmod']
    gohighright = basic_contrasts['HighReward'] + basic_contrasts['RightGo_pmod']
    golowleft = basic_contrasts['LowReward'] + basic_contrasts['LeftGo_pmod']
    golowright = basic_contrasts['LowReward'] + basic_contrasts['RightGo_pmod']
