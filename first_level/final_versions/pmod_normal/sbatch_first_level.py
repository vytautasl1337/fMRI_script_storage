...
derivatives_folder = os.path.join(os.path.join(working_dir,'derivatives/task_output/FirstLevel/FirstLevel_finalfinal'))
...
for index,comb in enumerate(combinations):
    ...
    design_matrices,design_matrix=design_mat(fmri_task,beh_table,events_dir,physio_dir,comb,
                                        subject_id,task_label,t_r,combination_output,space_label,
    ...
    for contrast_id, contrast_val in contrasts.items():
        ...
        correction = 'Uncorrected, p<.01'
        
        _, threshold = threshold_stats_img(maps['z_score'], alpha=0.01, height_control="fpr")
