...
def design_mat(fmri_task,beh_table,events_dir,physio_dir,comb,subject_id,task_label,t_r,
    ...
    for id_, img in enumerate(fmri_task):
        ...
        slopes=pd.DataFrame()
        slopes=pd.DataFrame({'RT_init': subject_beh['RT_init'], 'grips': go_conditions,
        ...
        mean_slopeL = left_grip_slopesL['RT_init'].mean(skipna=True)
        left_grip_slopesL['RT_init_demeaned'] = left_grip_slopesL['RT_init'] - mean_slopeL
        mean_slopeH = left_grip_slopesH['RT_init'].mean(skipna=True)
        left_grip_slopesH['RT_init_demeaned'] = left_grip_slopesH['RT_init'] - mean_slopeH
        
        right_grip_slopesL = slopes[slopes['grips'] == 'RightGoL'].copy()
        right_grip_slopesH = slopes[slopes['grips'] == 'RightGoH'].copy()
        
        mean_slopeL = right_grip_slopesL['RT_init'].mean(skipna=True)
        right_grip_slopesL['RT_init_demeaned'] = right_grip_slopesL['RT_init'] - mean_slopeL
        mean_slopeH = right_grip_slopesH['RT_init'].mean(skipna=True)
        right_grip_slopesH['RT_init_demeaned'] = right_grip_slopesH['RT_init'] - mean_slopeH
        ###########################################
        events_left_pmodL = pd.DataFrame({'trial_type': left_grip_slopesL['grips'], 
                                        ...
                                        'modulation':left_grip_slopesL['RT_init_demeaned']})
        ...
        events_right_pmodL = pd.DataFrame({'trial_type': right_grip_slopesL['grips'], 
                                ...
                                'modulation':right_grip_slopesL['RT_init_demeaned']})
        ...
        events_left_pmodH = pd.DataFrame({'trial_type': left_grip_slopesH['grips'], 
                                ...
                                'modulation':left_grip_slopesH['RT_init_demeaned']})
        ...
        events_right_pmodH = pd.DataFrame({'trial_type': right_grip_slopesH['grips'], 
                                ...
                                'modulation':right_grip_slopesH['RT_init_demeaned']})
        ...
        order = ['LeftGoL','LeftGoL_pmod', 'RightGoL','RightGoL_pmod',
                 'LeftGoH','LeftGoH_pmod', 'RightGoH','RightGoH_pmod',
